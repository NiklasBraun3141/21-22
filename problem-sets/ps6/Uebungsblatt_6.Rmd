...
thp <- read_csv("./data/THP_clean.csv")%>%
  select(newid, uc, depressed_1y, treat, age_baseline, age_baseline_sq, kids_no, famstruct_baseline, grandmother_baseline, edu_mo, edu_fa, 
         employed_mo_baseline, incomeindex, depindex_0, mspss_tot) 
